...
Resource.prototype.httpsRequest = function(o) {
  ...
  var request = https.request(options, function trueVaultRequest(res) {
    ...
    res.on('end', function trueVaultParseResponse() {
      ...
      var response = Buffer.concat(chunks, parseInt(res.headers['content-length']) || undefined);
      if(res.statusCode === 200) {
        ...
        var error = createError(res.statusCode, response);
